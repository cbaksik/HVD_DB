...
angular.module('viewCustom')
    .controller('customBarcodeCtrl',['customService','$stateParams','$scope',function (customService, $stateParams,$scope) {
        ...
        vm.getUrl=function () {
          ...
          cs.getAjax('/primo-explore/custom/HVD_DB/html/'+config,'','get')
        ...
        vm.searchPNX=function () {
            ...
            var params={'addfields':'','Inst':'HVD_DB','lang':'en_US','limit':10,'offset':0,'getMore':0,'mode':'advanced','pcAvailability':true,'q':'isbn,exact,0062020447,AND','vid':'HVD_DB','sort':'rank','rtaLinks':true,'scope':'everything','tab':'everything'}
...
angular.module('viewCustom')
    .component('customBarcode',{
        ...
        controllerAs:'vm',
        templateUrl:'/primo-explore/custom/HVD_DB/html/custom-barcode.html'
    });
